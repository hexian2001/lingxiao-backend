...
import { config as runtimeConfig, saveSettings, ConfigSchema, type MarketplaceSourceConfig, type McpServerConfig } from '@lingxiao-office/sdk/config.js';
...
} from '@lingxiao-office/sdk/core/SkillCatalog.js';
import { SkillDefinitionService } from '@lingxiao-office/sdk/core/SkillDefinitionService.js';
import {
  ...
  upsertMcpServer,
} from '@lingxiao-office/sdk/core/MarketplaceService.js';
import {
  contributionCounts,
  discoverPlugins,
  getPluginById,
...
} from '@lingxiao-office/sdk/core/plugins/PluginStore.js';
