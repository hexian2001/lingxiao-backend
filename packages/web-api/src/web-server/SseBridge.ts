import type { EventEmitter, EventMap, EventName } from '@lingxiao-office/sdk/core/EventEmitter.js';
import type { ConnectionManager } from './ConnectionManager.js';
import { isRunActiveStatus, normalizeRunStatus } from '@lingxiao-office/sdk/core/StateSemantics.js';
import {
  eventPayloadToEnvelope,
  eventPayloadToSessionUpdateMessage,
  type EventEnvelopeOptions,
  type EventType,
} from '@lingxiao-office/sdk/contracts/adapters/EventAdapter.js';
import { WORKFLOW_REALTIME_EVENT_NAMES } from '@lingxiao-office/sdk/contracts/types/Workflow.js';
import type { WorkflowRealtimeEventName } from '@lingxiao-office/sdk/contracts/types/Workflow.js';
