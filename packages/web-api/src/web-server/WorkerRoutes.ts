...
import type { SessionRuntimeState } from '@lingxiao-office/sdk/core/SessionRuntimeState.js';
import type { InteractionTurnState } from '@lingxiao-office/sdk/core/TurnCoordinator.js';
import { deriveRuntimeWaitGate, runtimeImpliesBusy } from '@lingxiao-office/sdk/core/StateSemantics.js';
import type { AgentHandle } from '@lingxiao-office/sdk/contracts/types/Agent.js';
import type { AuthFn } from './types.js';
import { killProcess } from '@lingxiao-office/sdk/utils/platform.js';
...
export function registerWorkerRoutes(
  ...
  fastify.get('/api/v1/processes', async (request, reply) => {
    if (!requireServerToken(request, reply)) return;
    const { PidRegistry } = await import('@lingxiao-office/sdk/core/PidRegistry.js');
