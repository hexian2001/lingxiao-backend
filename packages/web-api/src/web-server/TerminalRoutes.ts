...
import { killProcess, resolveInteractiveShell } from '@lingxiao-office/sdk/utils/platform.js';
import { serverLogger } from '@lingxiao-office/sdk/core/Log.js';
import { allowArbitraryTerminalCwd, shouldFilterChildEnv, filterEnv } from '@lingxiao-office/sdk/core/HardeningPolicy.js';
import { withToolProxyEnv } from '@lingxiao-office/sdk/core/ProxyConfig.js';
...
export function registerTerminalRoutes(
  ...
  fastify.get('/api/v1/terminal/ws', { websocket: true }, async (socket, request) => {
    ...
    try {
      const { getPty } = await import('@lingxiao-office/sdk/utils/getPty.js');
