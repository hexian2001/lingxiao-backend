...
import type { DatabaseManager } from '@lingxiao-office/sdk/core/Database.js';
import type { ConnectionManager } from './ConnectionManager.js';
import { getEventEmitter, type EventEmitter } from '@lingxiao-office/sdk/core/EventEmitter.js';
import { config as runtimeConfig, saveSettings, ConfigSchema, setConfigValue } from '@lingxiao-office/sdk/config.js';
import { getTerminalSessionManager } from '@lingxiao-office/sdk/tools/implementations/TerminalSessionManager.js';
import { isTerminalSessionActiveStatus } from '@lingxiao-office/sdk/core/StateSemantics.js';
import { eventPayloadToSessionUpdateMessage } from '@lingxiao-office/sdk/contracts/adapters/EventAdapter.js';
...
import { t } from '@lingxiao-office/sdk/i18n.js';
import { VERSION } from '@lingxiao-office/sdk/version.js';
...
import { extractAgentMention, isEmptyContent, type MessageContent } from '@lingxiao-office/sdk/llm/types.js';
import { MODE_REGISTRY, type ModeId } from '@lingxiao-office/sdk/contracts/modes.js';
import {
  buildMemoryMaintenanceStatus,
  currentMemoryProjectId,
  resolveMemoryWorkspace,
  runMemoryMaintenancePipeline,
} from '@lingxiao-office/sdk/memory/MemoryMaintenanceStatus.js';
...
export class AcpHandler {
  private _scheduledTaskManager?: import('@lingxiao-office/sdk/core/ScheduledTaskManager.js').ScheduledTaskManager;
  ...
  setScheduledTaskManager(stm: import('@lingxiao-office/sdk/core/ScheduledTaskManager.js').ScheduledTaskManager): void {
  ...
  private async handleMemoryToggle(params?: Record<string, unknown>, sessionId?: string) {
    ...
    // 动态更新 runtimeConfig
    const { config: runtimeConfig, updateConfig } = await import('@lingxiao-office/sdk/config.js');
