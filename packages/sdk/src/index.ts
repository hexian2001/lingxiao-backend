/**
 * 凌霄剑域可复用后端引擎 SDK - 公共入口
 *
 * 本包不依赖 Web API 层，可直接嵌入任意产品线：
 *   import { SessionManager, createLLMClient, createToolRegistry } from '@lingxiao-office/sdk';
 *
 * 也可深度按子路径导入（见 package.json exports "./*"）：
 *   import { LeaderAgent } from '@lingxiao-office/sdk/agents/LeaderAgent.js';
 */
...
export { createAgentLoop } from './facade/AgentLoop.js';
export type {
  AgentLoop,
  AgentLoopDoneEvent,
  AgentLoopFinishReason,
  AgentLoopHooks,
  AgentLoopMessageEvent,
  AgentLoopResult,
  AgentLoopRoundEvent,
